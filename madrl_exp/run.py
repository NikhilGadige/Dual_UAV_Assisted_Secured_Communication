"""Run MADRL experiments: training, evaluation, comparison — 3-agent version."""
...
from madrl_exp.evaluation import compare


def parse_args():
    parser = argparse.ArgumentParser(description="MADRL for ISAC — 3 agents")
