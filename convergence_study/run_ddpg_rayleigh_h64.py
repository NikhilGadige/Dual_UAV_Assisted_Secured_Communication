...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run DDPG convergence study with Rayleigh fading and h64.")
...
if __name__ == "__main__":
    args = _parse_args()
    run_convergence_experiment("ddpg", "rayleigh", 64, args.episodes, args.seed, args.device)
