...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run DQN convergence study with Rician fading and default h32.")
...
if __name__ == "__main__":
    args = _parse_args()
    run_convergence_experiment("dqn", "rician", 32, args.episodes, args.seed, args.device)
