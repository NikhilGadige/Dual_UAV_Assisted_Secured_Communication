...
def evaluate_dqn_multi_seed(
    ...
    output_dir: str = "outputs/evaluations/dqn",
...
def _parse_args():
    ...
    parser.add_argument(
        "--model-path",
        type=str,
        default="outputs/training/dqn/dqn_qnet.pt",
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evaluations/dqn", help="Output directory")
    parser.add_argument(
        "--channel-model",
        type=str,
        default="rician",
