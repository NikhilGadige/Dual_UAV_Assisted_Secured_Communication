...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run refined basic DDPG with Rayleigh fading and h32.")
...
if __name__ == "__main__":
    args = _parse_args()
    run_basic_experiment("ddpg", "rayleigh", args.episodes, args.seed, args.device, 32, 5e-4, args.output_root)
